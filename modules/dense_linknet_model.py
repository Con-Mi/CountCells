...
class DenseSegmModel(nn.Module):
    def __init__(self, input_channels, num_filters=32, num_classes=1, pretrained=False):
        ...
        self.layer1 = nn.Sequential(
            ConvEluGrNorm(inp_chnl=4, out_chnl=64),
            encoder[3] 
            )                               # /2   =256
        self.layer2 = encoder[4:6]     # /2   =128
        self.layer3 = encoder[6:8]     # /2   =64
        self.layer4 = encoder[8:10]    # /2   =32
        self.layer5 = encoder[10]
        self.pool = nn.AvgPool2d(kernel_size=3, stride=2, padding=1) # /2   =16
    ...
    def forward(self, x):
        ...
        dec1 = self.dec4(torch.cat([dec2, conv1], 1))
